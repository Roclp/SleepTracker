...
class AlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        try {
            when (intent?.action) {
                "com.example.SleepTracker.CANCEL_ALARM" -> handleAlarmCancellation()
    ...
    private fun buildNotification(context: Context): android.app.Notification {
        ...
        return NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .addAction(R.drawable.ic_snooze, "稍后", snoozePendingIntent)
            .addAction(R.drawable.ic_stop, "结束", stopPendingIntent)
            .setAutoCancel(false)
            .setOngoing(true)
